...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% This code will produce Figure 8 from the Supplementary Material. Power experiments for the Linear Abatement 
% case can be conducted by running the file "power_MCexperiment_LinearAbatement.m".
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Load
load(['Files/power_linAbate_DGP',num2str(DGP1),'_K',num2str(K),'_T',num2str(T)]);
...
axis([0,m_vec(end),0,17.5]);
ylabel('Average detection time','Interpreter','latex','FontSize',10);
title('DGP1','Interpreter','latex','FontSize',10);

%% Load
load(['Files/power_linAbate_DGP',num2str(DGP2),'_K',num2str(K),'_T',num2str(T)]);
...
%% Load
load(['Files/power_linAbate_DGP',num2str(DGP3),'_K',num2str(K),'_T',num2str(T)]);
...
%% Load
load(['Files/power_linAbate_DGP',num2str(DGP4),'_K',num2str(K),'_T',num2str(T)]);
