...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% This code will produce Figure 5 from the Supplementary Material. Before running the code, please download
...
mm_vals = [-0.05,-0.05,-0.10,-0.10]; % Magnitude of misreporting.
tau_vals = [30,45,30,45]; % Time to introduce misreporting.
...
for iS = 1:length(str)
    ...
    for iV = 1:length(mm_vals)
        ...
        plot(1:n,Zn_XR(:,1)/sqrt(omega2_hat),pl_cl{iV},'LineWidth',1.5), hold on
    end
    ...
    if iS == 4
        ...
        leg1 = legend('$\tau = 30, m = 0.05$','$\tau = 45, m = 0.05$','$\tau = 30, m = 0.10$','$\tau = 45, m = 0.10$','Location','NorthEast');
